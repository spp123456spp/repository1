...
@RestController
@Service("discriminate-IDCard-Test")
public class IDCardTest extends CommonApiOfInssue {
    ...
    @RequestMapping(value = "/discriminateIDCardTest",method = RequestMethod.POST)
    public Map discriminateIDCard(
        ...
        /*map.put("code",idCard.get("code"));
        map.put("msg",idCard.get("msg"));
        Map data=new HashMap();
        data.put("bizSeqNo",((Map) idCard.get("result")).get("bizSeqNo"));
        data.put("transactionTime", ((Map) idCard.get("result")).get("transactionTime"));
        data.put("ocrId", ((Map) idCard.get("result")).get("ocrId"));
        data.put("orderNo", ((Map) idCard.get("result")).get("orderNo"));
        data.put("name", ((Map) idCard.get("result")).get("name"));
        data.put("sex", ((Map) idCard.get("result")).get("sex"));
        data.put("nation", ((Map) idCard.get("result")).get("nation"));
        data.put("birth", ((Map) idCard.get("result")).get("birth"));
        data.put("address",((Map) idCard.get("result")).get("address"));
        data.put("idcard",((Map) idCard.get("result")).get("idcard"));
        data.put("warning", ((Map) idCard.get("result")).get("warning"));
        data.put("sign",((Map) idCard.get("result")).get("sign"));
        data.put("clarity", ((Map) idCard.get("result")).get("clarity"));
        data.put("multiWarning", ((Map) idCard.get("result")).get("multiWarning"));
        data.put("retry", ((Map) idCard.get("result")).get("retry"));
        data.put("success", ((Map) idCard.get("result")).get("success"));
        map.put("data",data);*/
        return idCard;
    }
